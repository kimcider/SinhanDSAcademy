...
public class MemberServlet extends HttpServlet {
	...
	private void printTable(PrintWriter pw, List<MemberVO> list) {
		...
		pw.println("<button><a href='/pro07/memberMaintenance/registeForm.html'>회원 가입으로 이동</a></button>");
		pw.println("<t>");
		pw.println("<button><a href='/pro07/memberMaintenance/updateForm.html'>회원 수정으로 이동</a></button>");
		pw.println("<t>");
		pw.println("<button><a href='/pro07/memberMaintenance/removeForm.html'>회원 삭제로 이동</a></button>");
